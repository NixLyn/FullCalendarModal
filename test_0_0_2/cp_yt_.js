  ...
  class DatePicker extends HTMLElement {
    ...
    render() {
      ...
      this.shadow.innerHTML = `
        ...
        <button type="button"  class="date-toggle" id="da_date" value="${date}">${date}</button>
        <div class="calendar-dropdown ${this.visible ? 'visible' : ''} ${this.position}">
          ...
          <div class="month-days"  id="${date}" onclick="click_alert(this.id);"></div>
        </div>
      `
    }
  }
